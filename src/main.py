...
if mode == "Drivers":
    ...
    if selected_teams:
        ...
        for team in selected_teams:
            ...
            seasons = races[races["raceId"].isin(
                results[results["constructorId"] == constructor_id]["raceId"]
            )]["year"].n
    ...
    if saved:
        load_name = st.sidebar.selectbox("Pick a saved comparison:", list(saved.key))
...
if mode == "Drivers" and selected:
    ...
    for name in selected:
        ...
        merged = driver_races.merge(races[["raceId", "year" ]], on="raceId")
